<%-- 
    Document   : WardOrCabin
    Created on : Oct 24, 2019, 11:50:25 AM
    Author     : user
--%>
...
<html>
    <head>
        ...
        <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.2.0/css/all.css" integrity="sha384-hWVjflwFxL6sNzntih27bfxkr279v+lsFkW54bOGbiDQ" crossorigin="anonymous">
        <title>Cabin Page</title>
        <style>
            .social-card-header{
    position: relative;
    display: -ms-flexbox;
                ...
                <div class="col-md-6">
                    <div class="card flex-md-row mb-4 shadow-sm h-md-250">
                        <div class="card-body d-flex flex-column align-items-start">
                            <strong class="d-inline-block mb-2 text-primary">V.I.P. Cabin</strong>
                            <h6 class="mb-0">
                                <a class="text-dark" href="#">Booking</a>
                            </h6>
